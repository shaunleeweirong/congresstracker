 ...
 *
 * All SQL migrations are stored here as TypeScript constants.
 * This ensures migrations are always available in the compiled code,
 * regardless of deployment platform or build configuration.
 */
